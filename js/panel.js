    ...
    .then((result) => {
      ...
      if (piso.photos) {
        ...
        photos.forEach((photo, index) => {
          photoHtml += `<li data-id="${index}" class="ui-state-default"><img src=".${photo}" width="auto" height="120px"/><img src="../resources/x.png" width="10px" height="10px" style="margin-left:5px;margin-bottom: 110px;" class="delete-btn"/> </li>`;
        });
